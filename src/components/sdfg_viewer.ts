...
export class SdfgViewerProvider
    ...
    public async handleMessage(
        ...
        switch (message.type) {
            ...
            case 'go_to_cpp':
                ...
                // otherwise get the cache directory of the currently opened
                // SDFG.
            ...
            case 'go_to_sdfg':
                ...
                if (message.zoomTo) {
                    msgs.push(
                        new SDFVMessage(message.sdfgName, {
                            type: 'zoom_to_node',
                            uuid: message.zoomTo,
                        })
                    );
    ...
    public openViewer(uri: vscode.Uri, messages: SDFVMessage[] = []) {
